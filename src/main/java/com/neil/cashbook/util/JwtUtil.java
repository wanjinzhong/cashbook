...
public class JwtUtil {
    ...
    private static final String defaultbase64EncodedSecretKey = "jerrycashbook";
     ...
     *
     * */
    public String encode(String openId, long ttlMillis, Map<String, Object> claims) {
        ...
        JwtBuilder builder = Jwts.builder()
                                 ...
                                 .setSubject(openId)//3. 签发人，也就是JWT是给谁的（逻辑上一般都是username或者userId）
